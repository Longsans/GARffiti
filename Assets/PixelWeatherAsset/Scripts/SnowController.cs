...
public class SnowController : MonoBehaviour
{
    ...
    public void OnScaleChanged(Vector3 localScale)
    {
        ...
        snowMain.gravityModifier = new ParticleSystem.MinMaxCurve(snowMain.gravityModifier.constantMin * localScale.magnitude,
                                                        snowMain.gravityModifier.constantMax * localScale.magnitude);
    }
